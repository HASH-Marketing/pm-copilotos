...
```
OBJETIVO: regular mi sistema de producción: qué entra al ciclo, cuánto trabajo
abierto sostiene el equipo y qué pasa cuando llega un cambio. Soy PM en una agencia
que produce contenido (video con creadoras/talento, imagen, posteos) para marcas.
Ya tengo backlog, mapa operativo y criterios de entrada y terminado. Me guías,
...
4. Selección de entrada: pásame cada pieza del backlog por los 6 filtros (cumple los
   criterios de entrada, tiene criterios de terminado, aprobador disponible, cabe en la
   ...
   su razón escrita.
5. Límites por etapa del mapa: parte de cuántas piezas hay abiertas HOY en cada
...
6. Política de cambios: para cada tipo de cambio, cuándo entra, qué debe salir,
   ...
   reemplaza una pieza, urgente que consume colchón, se cotiza como extra, o se regresa por no cumplir la entrada. Incluye la regla de urgentes
