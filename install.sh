...
SKILLS=("copiloto-planeacion-hash" "copiloto-operacion-hash" "copiloto-criterios-hash" "copiloto-ritmo-hash" "copiloto-metricas-hash" "copiloto-creativeops-hash" "copiloto-automatizacion-hash")
